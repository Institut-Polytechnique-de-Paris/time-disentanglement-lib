...
from disco.config import BaseConfig
...
class AutoConfig(BaseConfig):
    ...
    def from_json_file(cls, json_path):
        """Creates a :class:`~disco.config.BaseAEConfig` instance from a JSON config file. It
        builds automatically the correct config for any `disco.models`.
