...
:class:`disco.models.normalizing_flows` and named likewise the model. The following modules can be 
found in this folder:

- | *modelname_config.py*: Contains a :class:`ModelNameConfig` instance inheriting
    from :class:`~disco.models.normalizing_flows.BaseNF`. 
- | *modelname_model.py*: An implementation of the model inheriting either from
    :class:`~disco.models.normalizing_flows.BaseNFConfig` 
