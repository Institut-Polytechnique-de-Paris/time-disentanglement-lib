...
class TimeGenerationPipeline(Pipeline):
    ...
    Parameters:
        ...
        model (Optional[BaseAE]): An instance of :class:`~disco.models.BaseAE` you want to train.
            If None, a default :class:`~disco.models.VAE` model is used. Default: None.

        training_config (Optional[BaseTrainerConfig]): An instance of
            :class:`~disco.trainers.BaseTrainerConfig` stating the training
    ...
    def __call__(
        ...
        Args:
            ...
            callbacks (List[~disco.trainers.training_callbacks.TrainingCallbacks]):
