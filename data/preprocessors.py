...
:class:`~disco.trainers.Trainer`. In particular, an input data is converted to a
:class:`torch.Tensor` and all the data is gather into a :class:`~disco.data.datastest.BaseDatset`
instance.
...
from disco.data.datasets import BaseDataset
...
class DataProcessor:
    ...
    **minimal shape**.
    ...
    def to_dataset(data: torch.Tensor, labels: Optional[torch.Tensor] = None):
        ...
        :class:`~disco.data.datasets.BaseDataset`
