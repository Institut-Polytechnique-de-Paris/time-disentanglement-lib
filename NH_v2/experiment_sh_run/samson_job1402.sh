...
# CONFIG:
#Samson --> N:9025, nr:95, nc:95, H:2, L:156, P:3

python main.py \
--root_path //tsi/data_education/Ladjal/koublal/open-source/NH_v2 \
--data_option 'Samson' \
--data_path //tsi/data_education/Ladjal/koublal/open-source/IDNet/DATA/real_Samson/alldata_real_Samson.mat \
--data_path_extract //tsi/data_education/Ladjal/koublal/open-source/IDNet/DATA/real_Samson/extracted_bundles.mat \
--percentage 0.05 \
--input_dim 1 \
--endmembers_dim 5 \
--abundance_dim 5 \
