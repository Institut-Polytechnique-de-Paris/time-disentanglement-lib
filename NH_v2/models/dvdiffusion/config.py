...
class TrainerDVDiffusion(LightningModule):
    ...
    def forward(self, batch_y_unsup, batch_y_sup, batch_m, batch_a, t):
        ...
        return self.model(batch_y_sup, batch_y_sup,batch_m, batch_a, t, self.current_epoch)
    ...
    def validation_step(self, val_batch: Tensor, batch_idx: int) -> Dict:
        ...
        # _, out, _, _ = self.model.inference(batch_y_sup) #self.pred_net(batch_y_sup)        
        ...
        y_hat, mu_unsup, log_var_unsup, abundance_pred_unsup, endmemebers_pred_unsup = self.model.inference(batch_y_unsup)
    ...
    def test_step(self, batch, batch_idx):
        ...
        # self.log("val_loss", self.loss)
        # return {"vloss":  self.loss, "val_loss": self.loss}
        y_hat, mu, log_var, abundance_pred, endmemebers_pred = self.model.inference(batch_y_unsup.squeeze(-1))
